package com.beizhi.cloud.services.b.conf;
...
//mybaits dao 搜索路径
@MapperScan("com.beizhi.cloud.services.b.dao")
public class MybatisDataSource {
	@Autowired
	private DataSourceProperties dataSourceProperties;
	//mybaits mapper xml搜索路径
	private final static String mapperLocations="classpath:com/beizhi/mappers/*.xml";
